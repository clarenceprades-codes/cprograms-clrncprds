...
void    getData(STUD *stu,char *name, int *q1, int *q2, int *q3, float *ave); // Getting data from user.
...
void updateStud(STUD *stu, char *n);// Update
        ...
        switch(menu())
        {
            case '1':
            {
                ...
                else
                {
                    ...
                    getData(stu,stu[last].name, &stu[last].quiz1, &stu[last].quiz2,&stu[last].quiz3, &stu[last].ave);  //passes the address of the last array index for addition of data
                }
            }
                break;
             ...
             case '4':
            {
                char name[20];
                system("cls");
                printf("\n\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 UPDATE MODE \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\n\n");
...
char menu()
{
    ...
    printf("\n\tPress the key of your choice (1-5): ");
   choice=getch();
...
void getData(STUD *stu,char *name, int *q1, int *q2,int *q3, float *ave)
{
    ...
    int i;
        ...
        if(strcasecmp(stu[i].name,name)==0) // comparing inputted string on elements of struct name.
        {
...
void updateStud(STUD *stu, char *n)
{
    int i;
    int q1,q2,q3;
    if(strcasecmp(stu[i].name,n)==0) // comparing inputted string on elements of struct name.
        {
            printf("\tEnter new quiz 1 of %s: ", n);
            scanf("%d",&q1);
            printf("\tEnter new quiz 2 of %s: ", n);
            scanf("%d",&q2);
            printf("\tEnter new quiz 3 of %s: ", n);
            scanf("%d",&q3);
            stu[i].quiz1=q1;
            stu[i].quiz2=q2;
            stu[i].quiz3=q3;
            stu[i].ave=(q1+q2+q3)/3.0;
